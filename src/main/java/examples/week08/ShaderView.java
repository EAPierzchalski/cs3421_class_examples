 ...
 * @author malcolmr
 */
public class ShaderView implements GLEventListener, MouseMotionListener {

    private static final int ROTATION_SCALE = 1;
    private static final String VERTEX_SHADER = "src/main/java/examples/week08/phong_vertex.glsl";
    private static final String FRAGMENT_SHADER = "src/main/java/examples/week08/phong_fragment.glsl";
    private ShaderExample myModel;
    ...
    public ShaderView(ShaderExample model) {
        myModel = model;
    }
